...
# IT 技术 
 ...
 ## [太酷了吧，在VS Code上就可以直接读Github代码了](http://developer.51cto.com/art/202102/646820.htm)
...
# PM 
 ...
 > 产品只是工具，而我们的目的是通过将产品作为媒介，来满足客户的需求，获得预期回报，但是并不是所有的需求都是值得探讨的，甚至会跳入误区而不自知。文中总结了用户挖掘最易入的3个误区，来看看你踩雷了吗？
 ## [从一个“奇葩”弹窗 深入理解微信的产品设计理念](http://www.chanpin100.com/article/113601)
 > 事情的起因来源于我在微信的如下使用场景：朋友定了一款生日蛋糕很好吃，于是我跟他要了蛋糕店的微信号，准备添加店主微信订蛋糕。
 ## [下单减库存与付款减库存的优缺点及其使用场景](http://www.chanpin100.com/article/113600)
 > 库存管理是电商交易环节最重要的一环，同时也直接影响到电商履约环节。可以说，对于一个电商系统来说，库存管理做的好与坏，对整个电商系统至关重要。本篇文章主要介绍下单减库存与付款减库存的优缺点及其适用的场景。
 ## [用户场景如何影响产品的体验设计](http://www.chanpin100.com/article/113599)
