...
copyright: true
date: 2019-09-01 09:00:49
tags: IT NEWS
categories: IT NEWS
---
# IT 新闻 
 ## [为何女性在VR晕动症上比比男性更明显?](http://mp.weixin.qq.com/s?src=11&timestamp=1567299603&ver=1825&signature=HSRu0y9HEdu2k7IWQ5zDgr3paJNnqciYTeec*f8o6Q0RFSbpRb8x*aRyQNEfY9pi5h1w*LzhOEY1rifZtrovwoTLBt7s9IiqKxq-C1N7iClOCAoGLx*BSwG2EAVtAzxf&new=1)
 > Esther｜ 编辑晕动症是多年来伴随着VR的一个不可忽视的问题，上世纪九十年代曾尝试商业化的任天堂Virtual Boy和世嘉VR也因为无法解决眩晕和恶心感而不幸夭折。此外据2017年的一份调查报告显示，大约有25到45%的...
 ## [取代安卓第一枪!华为鸿蒙系统/方舟编译器开源：已有45款应用](http://mp.weixin.qq.com/s?src=11&timestamp=1567299603&ver=1825&signature=KYVJ7ERMGcXpfhg0q7SgIDmiEX9JZSdo77ABNdWk6*-stlBtqO31YwhMZDSPRZScdHQwbRZlEtPDTAxS9nyhZqmPM1qvHDyZTTm0Bw68-10reOs*xRf1GRJg2KA7H5Ic&new=1)
 > 今天对于华为来说是个非常值得庆贺的日子，所谓万里长征第一步，华为已经迈了出去。华为正式宣布旗下鸿蒙系统，方舟编译器全面开源，广招第三方开发者适配，为华为打造专属的生态空间。而虽然方舟编译器目前是运...
 ## [中国自动驾驶补完计划：这款 AI 芯片为何如此重要?](http://mp.weixin.qq.com/s?src=11&timestamp=1567299603&ver=1825&signature=gtIzH49T0c02gtK5xwFtRjUjD20ZSE6gbNzfLoW144gWcKYu2TSi0zi28tbeZAh-eW9TZ64hosdE1-6S4xlDRB6uoNAhx5h2pVCAZn-iICY0LnXK6YExerz4LdEB-X64&new=1)
 > 这家估值 30 亿美元独角兽的投资者们，可以感慨一句「钱没白花」了。「今天，对于中国自动驾驶事业来说是一个特别的日子。」8 月 30 日的上午，地平线创始人&amp;CEO 余凯，用这句宣告，开始了自己的演讲。地平线创...
 ## [\[报告\]自动驾驶传感器系列之格局和路径(附33页PDF文件下载)](http://mp.weixin.qq.com/s?src=11&timestamp=1567299603&ver=1825&signature=uEiMGmcrf1r8dENSa7MEAXz-orROwbQmzlpnmiCZcTF-d-QSPCXwa1IgfAsYriEe44Rfgls2Gq*6Z0WOKcSQJJMS5JywDiSeLk5zyfUmBc31J5gGW7bQ5ywBBIDRxJTV&new=1)
 > 与其相忘江湖，不如点击“蓝字”关自动驾驶汽车作为汽车未来的重要发展方向，成为汽车零部件产业链的重要增长点。国内外的汽车零部件供应商积极布局自动驾驶传感器领域，在车载摄像头、毫米波雷达和激光雷达三大...
 ## [说到做到，华为方舟编译器开源了!对OV小米影响几何?](http://mp.weixin.qq.com/s?src=11&timestamp=1567299603&ver=1825&signature=PDIZANB2lc3IkxiP8kf14NCDbywKHf7HF8W5LNYCL6dQDk4c5277mqfuMwTG8cLroFxiocww*kgzCEvn3WCmYFgbl94FHP9i0E81hn2ytkTepyvKtH0zZkl15MYCKX9E&new=1)
...
# IT 技术 
 ...
 ## [Windows系统如何mount盘符到目录](https://blog.csdn.net/dog250/article/details/100140882)
 > Windows系统如何mount盘符到目录
 ## [【思考】再谈面向过程与面向对象](https://blog.csdn.net/qq_42322103/article/details/100171578)
 > 【思考】再谈面向过程与面向对象
 ## [【Java核心技术卷】理解Java的继承与多态重要概念](https://blog.csdn.net/qq_42322103/article/details/88726779)
 ...
 > 算法学习总结（2）——温故十大经典排序算法
 ## [TensorFlow 2.0 版本安装教程+CNN图像mnist手写数字识别实战代码-CNN图像识别](https://blog.csdn.net/weixin_37479258/article/details/100168201)
 > TensorFlow 2.0 版本安装教程+CNN图像mnist手写数字识别实战代码-CNN图像识别
 ## [su和sudo的区别与使用](https://blog.csdn.net/devcloud/article/details/100173198)
 > su和sudo的区别与使用
 ## [NLP这两年：15个预训练模型对比分析与剖析](https://blog.csdn.net/dQCFKyQDXYm3F8rB0/article/details/100179105)
 ...
 > 【技巧】我是如何 &quot;搜索&quot; 到想要的信息的
 ## [开发必学的验证码，教你从零写一个验证码](https://blog.csdn.net/u012365828/article/details/100168556)
 > 开发必学的验证码，教你从零写一个验证码
...
# 人工智能 
 ...
 ## [Springboot前端thymeleaf html页面js,css相对路径引用问题解决](https://blog.csdn.net/qq_29964641/article/details/94600565)
 > Springboot前端thymeleaf html页面js,css相对路径引用问题解决
 ## [表格-图片上传 div  拖动排序](https://blog.csdn.net/cailongbiaoyuli/article/details/97938088)
 > 表格-图片上传 div  拖动排序
 ## [js 常用的方法](https://blog.csdn.net/wangshang1320/article/details/93173573)
 > js 常用的方法
 ## [【jQuery】第二课：案例实践——运用JavaScript制作一个简易的四则运算计算器](https://blog.csdn.net/dnruanjian/article/details/95462893)
 ...
 > 前端开发应知网站(强烈推荐！)
 ## [javascript高级](https://blog.csdn.net/Denisedan/article/details/97045785)
 > javascript高级
 ## [vue移动端 实现手机左右滑动入场动画](https://blog.csdn.net/qq_39045645/article/details/95978194)
 > vue移动端 实现手机左右滑动入场动画
 ## [this的指向](https://blog.csdn.net/weixin_43606158/article/details/90136929)
 > this的指向
 ## [React用户登录界面](https://blog.csdn.net/linjiru1191/article/details/94569318)
 > React用户登录界面
 ## [前端一到三年最全面试题（一）](https://blog.csdn.net/weixin_43606158/article/details/89811189)
 > 前端一到三年最全面试题（一）
 ## [解决ASP.NET母版页title标签问题](https://blog.csdn.net/Darrenzzb66/article/details/97789370)
 > 解决ASP.NET母版页title标签问题
