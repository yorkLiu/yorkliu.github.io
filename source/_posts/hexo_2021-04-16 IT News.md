...
# IT 技术 
 ...
 > PyQT5 主窗口打开新窗口(帮助文档)
 ## [蓝桥杯第十二届模拟题](https://blog.csdn.net/sxx_xxs/article/details/115679972)
 > 蓝桥杯第十二届模拟题
 ## [新版 cocoapod安装和使用 , 安装中出现的错误及解决方案](https://blog.csdn.net/qq_22220403/article/details/86523832)
 > 新版 cocoapod安装和使用 , 安装中出现的错误及解决方案
 ## [常见的日期计算问题（模板）](https://blog.csdn.net/m0_46549425/article/details/115445821)
 > 常见的日期计算问题（模板）
 ## [GO grpc](https://blog.csdn.net/leekerian/article/details/115654055)
 > GO grpc
 ## [Linux常用命令（非常详细！）](https://blog.csdn.net/lq56789/article/details/115605128)
 > Linux常用命令（非常详细！）
 ## [我以为我对Vue很了解，直到我遇到了阿里的面试官](https://blog.csdn.net/weixin_56134381/article/details/115640115)
...
# PM 
 ...
 > 免费阅读悄悄崛起，互联网巨头持续加码网文生态。当“免费”吸引来的用户达到饱和，流量红利的浪潮退去，免费阅读的增长点又会在哪里？
 ## [硬件产品开发指南「构思、设计、工程、验证」](http://www.chanpin100.com/article/114567)
 > 与软件封闭开发不同，硬件产品会涉及供应链和渠道管理，对成本和时间的限制性要求较高。硬件产品很难实现类似软件产品的快速迭代，初创硬件公司也往往只有一次机会来交付产品。
 ## [B端与C端的区别之竞争对手有什么不同？](http://www.chanpin100.com/article/114636)
 > 随着互联网的迅速发展进步，现在产品经理这个岗位的需求也越来越多了，B端产品经理作为其中一个比较重要的一个方向，了解B端与C端之间的差异会更容易上手展开工作。今天，本文给大家介绍一下二者之间在竞争对手方面有什么不同。
 ## [以系统化视角反观产品运营 解读提升用户转化的“四部曲”](http://www.chanpin100.com/article/114566)
 > 正常的活动运营通常会围绕公司经营目标，针对不同性质、不同类型的活动开展工作。这样的活动一般会分四个阶段：活动准备、活动策划、活动执行与活动复盘阶段。
 ## [智慧城市：大数据运营中心IOC——WebGIS地图应用](http://www.chanpin100.com/article/114565)
 > Hightopo 的 HT for Web GIS 产品让 GIS 数据的可视化展示形式更加丰富，更加清晰直观，让即使不清楚具体业务的人也能一眼看懂数据意义。
 ## [B端与C端的区别之运营方面有什么不同？](http://www.chanpin100.com/article/114635)
 > 对于B端产品经理来说，了解B端与C端之间的差异其实就是理解二者本质的一个过程，只有清楚地掌握了他们之间的差异，工作才能更顺利地进展下去。那么，B端与C端在运营上有什么不同呢？下面请看本文的介绍。
 ## [B端与C端的区别之成本转移有什么不同？](http://www.chanpin100.com/article/114633)
 > 上一章中，我们为大家简单介绍了一下B端与C端产品在功能设计方面的不同，不知道大家有没有对这些内容进行消化吸收呢？本文给大家分享的是B端与C端在成本转移上的不同点，但愿能帮助到你。
 ## [互·联·网·这·群·人·呵](http://www.chanpin100.com/article/114629)
 > 能做互联网的，个个都是人才。今天直白的给大家介绍一下他们：
 ## [大数据是什么 简单爬一爬！](http://www.chanpin100.com/article/114562)
 > 大数据（big data），IT行业术语，是指无法在一定时间范围内用常规软件工具进行捕捉、管理和处理的数据集合，是需要新处理模式才能具有更强的决策力、洞察发现力、流程优化能力的海量、高增长率和多样化的信息资产。
 ## [零基础小白怎么快速入行互联网产品经理？](http://www.chanpin100.com/article/114561)
 > 招聘信息里包括了两部分，一部分是岗位职责，另一部分是任职要求。岗位职责就是你入职后需要做的事，也是你入职后的工作内容。任职要求就是这个岗位的门槛，只有你达到了这个门槛，才有可能被选中。
 ## [B端与C端的区别之功能设计有什么不同？](http://www.chanpin100.com/article/114631)
 > 对于一个B端产品经理来说，必须要掌握B端产品与C端产品有哪些相同点又有哪些不同点，这样在往后工作的开展上才会更加顺利，本文为大家分析一下B端与C端在功能设计上有什么不同。
 ## [B端与C端的区别之用户体验有什么不同？](http://www.chanpin100.com/article/114630)
 > 在上一篇文章中，给大家简要介绍了一下B端与C端在使用场景上的区别，今天再来给大家介绍介绍二者在用户体验方面有哪些不同，希望本文的分享能对您的学习有所帮助。
 ## [B端与C端的区别之使用场景有什么不同？](http://www.chanpin100.com/article/114628)
 > 作为B端产品经理，做好本职工作的一个前提就是要了解B端产品与C端产品之间的区别，那么本文就给大家介绍一下这二者之间在使用场景上有什么不同，希望我的分享可以帮助到您。
 ## [王者的简历就这么简单 你看了就会HR看了就想约](http://www.chanpin100.com/article/114627)
 > 原创【王者的简历就这么简单，你看了就会，HR看了就想约】为了创作此篇，多次请教前辈大佬，几易其稿，精血成聚，终于写出了一篇还算过关的朴实而有价值的简历文章。无论是即将毕业的学生还是正在工作的你都不防静心读一读，一定会对你有所帮助。如果有一天，朋友让你帮忙看看简历，你再也不会因没有经验而找任何借口，你
 ## [你的项目为什么永远在延期？](http://www.chanpin100.com/article/114626)
 > 做过项目管理的人，都肯定有所体会，这里面充满了坑点。你以为会按时间顺利完成，但往往充满波折，甚至最后实现的东西，可能和你最初的设想千差万别。
 ## [产品初创时 如何获取客户反馈](http://www.chanpin100.com/article/114624)
