...
# IT 新闻 
 ...
 > 去年 5 月，我们曾报道过 GNOME 在讨论将代码迁移到 GitLab ，原因是现有的代码托管设施和 bug 跟踪系统 Bugzilla 维护起来日益困难。据悉，由于 GNOME 运行的是一个旧的 Bugzilla 定制版本，每次更新都大费周章，而且 Bugzilla 也没有与代码库整合在一起，种
 ## [Istio 0.8.0 LTS 正式发布，大型微服务系统管理平台](https://www.oschina.net/news/96681/istio-0-8-released)
 > 北京时间 2018 年 6 月 1 日（儿童节）上午 9: 30 Istio 0.8.0 LTS（长期支持版本）发布。该版本除了常见的一堆错误修复和性能改进之外，还包含以下更新和新功能。 网络 改进了流量管理模型。我们终于准备好了推出新的流量管理配置模型。该模型增加了许多新功能并解决了先前模型的可用
 ## [Kubernetes v1.11.0-beta.1 发布，容器编排工具](https://www.oschina.net/news/96680/kubernetes-v1-11-0-beta1-released)
 > Kubernetes v1.11.0-beta.1 已发布，更新内容十分多，详情请点此查看。 值得关注的变化有： Remove rescheduler from master. (64364, @ravisantoshgudimetla) Declare IPVS-based kube-proxy
...
# 人工智能 
 ...
 > \[机器学习\]神经网络反向传播的推导
 ## [从零开始机器学习-11 特征工程（下）](http://blog.csdn.net/sqy941013/article/details/80536166)
 > 从零开始机器学习-11 特征工程（下）
 ## [从零开始机器学习-12 特征组合](http://blog.csdn.net/sqy941013/article/details/80536169)
 > 从零开始机器学习-12 特征组合
 ## [从零开始机器学习-13 正则化](http://blog.csdn.net/sqy941013/article/details/80536171)
 > 从零开始机器学习-13 正则化
 ## [从零开始机器学习-14 逻辑回归](http://blog.csdn.net/sqy941013/article/details/80536173)
 > 从零开始机器学习-14 逻辑回归
 ## [从零开始机器学习-15 分类](http://blog.csdn.net/sqy941013/article/details/80536176)
 > 从零开始机器学习-15 分类
 ## [从零开始机器学习-16 初探神经网络（Neural Network）](http://blog.csdn.net/sqy941013/article/details/80536177)
...
# PM 
 ## [GDPR（通用数据保护法案）对社交媒体运营有什么影响？](http://www.woshipm.com/operate/1046656.html)
 > 本文作者将分享GDPR给您的业务和客户带来的一些好处，以及介绍一些社交媒体营销需要注意的重要事项。enjoy~GDPR最近在互联网出海圈流行起来，比较多的是讨论其对产品...
 ## [定量研究：需要测试多少用户？](http://www.woshipm.com/user-research/1045213.html)
 > 在收集可用性指标问题时，20 个用户的测试通常会提供相当可靠的置信区间。我们可以根据质量指标定义可用性，例如学习时间、使用效率、可记忆性，用户错误和主观满意度...
 ## [分享功能的主动和被动：隐藏着用户思辨化的心理](http://www.woshipm.com/pd/1046684.html)
 > 如何有效引导用户进行分享？本文作者将在此与大家聊聊分享功能的主动和被动，enjoy~随着微信的普及，分享功能在互联网2C产品中可谓随处可见，而看似简单的功能，背后...
 ## [经验总结 | 产品经理高质量产物的五步思维法](http://www.woshipm.com/pmd/1046716.html)
 > 本文作者结合自身工作经验，抽象出5种思维模式，带你探寻一项高质量产物的背后，完成者具备了怎样的思维素质。enjoy~职场中经常会遇到以下场景：领导安排工作跨部...
 ## [关闭推荐系统，你会看见不一样的世界](http://www.woshipm.com/pd/1039461.html)
