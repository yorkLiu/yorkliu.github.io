...
# IT 技术 
 ...
 > 目前正值华为云微服务一周年之际，特意为码云用户备上了诚意好礼，只要GET如下姿势，就能体验微服务平台的专属特权，获得价值200元华为云代金券；限量500份，先到先得！
 ## [OSChina 周六乱弹 — 也许我们能见证硅基生物的诞生](https://my.oschina.net/xxiaobian/blog/1838030)
 > 邻居家开小商店，门口一般会有打麻将的大叔阿姨，一天我带着我家狗站一大叔后面看他打，他一手打牌一手持冰棍，出牌的时候顺带啃一口，然后手就垂在旁边。我家狗一声不吭蹲他背后，手放下来就舔一口，绝不多舔，众人看到都不吭气，直到大叔跟狗把冰棍吃完……
 ## [码云推荐 | 简单实用的 web 截图工具 kscreenshot](https://gitee.com/kejiacheng/kscreenshot/)
 > kscreenshot 是一个实用的 web 截图工具，带有下载，复制功能。工具栏功能从左到右依次为：椭圆，矩形，线条，箭头，后退，完成。
 ## [PESCMS Ticket —— PHP 开发的客服工单系统](https://www.oschina.net/p/pesmcs-ticket)
 > PESMCS Ticket (下称PT) 是一款基于 GPLv2 协议发布的开源客服工单系统。PT 以全新的设计理念，实现一句 JS 即可嵌入任意页面中，让工单系统变得更加轻便。
 ## [Gentoo Linux 的 GitHub 仓库被入侵，意图删除所有文件](https://www.oschina.net/news/97570/gentoo-linux-organization-hacked)
 > UTC 时间6月28日晚，Gentoo Linux 的 Github 仓库受到黑客攻击，并在 20:20 成功取得了组织的控制权。攻击者篡改了存储库的内容以及页面，并用恶意 ebuild 文件替换了 portage 和 musl-dev trees 中的文件，意图删除储存库上的所有文件。 当天 21
 ## [围剿 iOS ？Google 2200 万美元投资 KaiOS 并达成合作](https://www.oschina.net/news/97569/google-investment-round-kaios)
 > 之前我们曾报道过，DeviceAtlas 最新数据显示 2018 年第一季度 KaiOS 成功逆袭超越 iOS 成为印度第二大移动操作系统。6月28日，KaiOS 发文宣布已完成由 Google 领投的 2200 万美元 A 轮融资。 KaiOS Technologies CEO 表示：“这笔资金将
 ## [gRPC 1.13.0 发布，谷歌开源的高性能 RPC 框架](https://www.oschina.net/news/97568/grpc-1-13-0-released)
 > gRPC 1.13.0 已发布，此版本包含重要的改进和错误修复，针对 Objective-C、PHP 和 Python 这几个语言版本都有重要的更新，其中重点列出如下： Core gRPC stats will only be collected for debug builds or if GRP
 ...
 > 北京时间6月30日，Linux Mint 团队正式宣布释出 Linux Mint 19 &quot;Tara&quot; 的正式稳定版，包括 Xfce, MATE 和 Cinnamon 这三个桌面环境版本。Linux Mint 19 基于 Ubuntu 18.04，并将获得五年的技术支持。 下载地址 Cinnamon 
...
# PM 
 ## [为何如今的产品总给人千人一面的感觉？](http://www.woshipm.com/ucd/1078394.html)
