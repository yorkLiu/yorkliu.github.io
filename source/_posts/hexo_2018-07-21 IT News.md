...
# IT 新闻 
 ...
 > 泻药，作为同行，狮子来替友商解释一下，顺便分享点数据和知识，整个2018年上半年，中国移动互联网用户仅仅增加了2000万，而存量已经达到了11个亿，这是个什么意思呢？意思就是互联网的红利期结束了，线上的增长遭遇...
...
# IT 技术 
 ...
 ## [四个月了，Windows 10 装机量还停留在 7 亿](https://www.oschina.net/news/98211/win10-installation-capacity-stays-at-700-billion)
 > 微软公布了 2018 财年的四季度财报，不过该公司 CEO 萨蒂亚·纳德拉在财报电话会议期间指出，尽管 Windows 10 PC 在持续增长，这款操作系统的设备安装量仍未突破 7 亿。早在 3 月份的时候，我就已经从前任 Windows 首席 Terry Myerson 的告别信里听说了“Wind
 ## [OSChina 周六乱弹 —— 妹子和游戏哪个更好玩](https://my.oschina.net/xxiaobian/blog/1860426)
 > 空调是我的再生父母, 感谢给了我第二次生命, 这辈子我都不要离开你.
 ## [与代码面对面，“独自编程”让工作效率更高](https://www.oschina.net/news/98209/forever-alone-programming)
 > “独自工作”会让人联想到什么？狂野西部的不法之徒，搁浅火星的宇航员还是站在楼顶的蝙蝠侠？在编程领域，如果你曾经是一名自由职业者，你就会知道在最后期限内迷失自己并且一次又一次陷入同样的错误是多么容易。 独自编程法 独自编程法（Forever Alone Programming）是一位 ID 为 nop
 ## [罚完 Google，欧盟反垄断监管机构又瞄准了高通](https://www.oschina.net/news/98208/eu-aims-to-qualcomm)
 > 据路透社报道，欧盟反垄断监管机构加强了对全球领先的芯片制造商高通的指控。此前，高通被指控以低于成本的价格销售芯片组，以排挤竞争对手。 当地时间周四，欧盟司法部门表示，它已向高通发送了另一份指控清单。这类文件通常会坐实监管机构的初步结论，并针对企业对最初指控清单的提问做出解释。 欧盟委员会表示：“今天
 ## [SQL Server PHP 驱动 5.3.0 发布，支持 Ubuntu 18.04](https://www.oschina.net/news/98207/msphpsql-5-3-0-released)
 > 微软 SQL Server PHP 驱动 5.3.0 发布了，该驱动程序允许从 Linux、Windows 和 macOS 上的 PHP 7.0-7.2 应用程序访问 SQL Server、Azure SQL 数据库、Azure SQL 托管实例和 Azure SQL DW。 此次更新内容如下： A
 ## [Next.js 6.1.1 Canary 2 发布，React 服务器端渲染框架](https://www.oschina.net/news/98206/next-js-6-1-1-canary2-released)
 ...
 > 牛市要来？7月27日聚焦华尔街 2018 虚拟货币对冲基金峰会！
...
# 人工智能 
 ...
 ## [【转账】常见的几种initializers](https://blog.csdn.net/xky1306102chenhong/article/details/81131610)
 > 【转账】常见的几种initializers
 ## [caffe模型转ncnn模型](https://blog.csdn.net/soralaro/article/details/81131615)
 > caffe模型转ncnn模型
 ...
 > 四类通用算法比较
 ## [一行代码结果叹为观止，能做到这么极致的也只有python了](https://blog.csdn.net/qq_42238397/article/details/81131750)
 > 一行代码结果叹为观止，能做到这么极致的也只有python了
 ## [《深度学习：21天实战Caffe》 learning note](https://blog.csdn.net/bryant_meng/article/details/81131820)
 > 《深度学习：21天实战Caffe》 learning note
 ## [【TensorFlow重大升级】自动将Python代码转为TF Graph，大幅简化动态图处理！](https://blog.csdn.net/weixin_40581617/article/details/81131879)
 > 【TensorFlow重大升级】自动将Python代码转为TF Graph，大幅简化动态图处理！
 ## [本体（Ontology）概述](https://blog.csdn.net/m0_37788308/article/details/81131886)
 > 本体（Ontology）概述
 ## [Particle Filter Tutorial 粒子滤波：从推导到应用（一）](https://blog.csdn.net/lightrain0/article/details/81131967)
 > Particle Filter Tutorial 粒子滤波：从推导到应用（一）
 ## [Particle Filter Tutorial 粒子滤波：从推导到应用（二）](https://blog.csdn.net/lightrain0/article/details/81132028)
 > Particle Filter Tutorial 粒子滤波：从推导到应用（二）
 ## [yolo训练自己的数据集，如何生成图像标签txt文件](https://blog.csdn.net/qq_38214193/article/details/81132053)
 > yolo训练自己的数据集，如何生成图像标签txt文件
 ## [Particle Filter Tutorial 粒子滤波：从推导到应用（三）](https://blog.csdn.net/lightrain0/article/details/81132066)
...
# PM 
 ...
 > 【小百摘要】不同的产品类型也会有其特点，这篇文章想分享一下手机预装产品的四个特点。
 ## [彻底抛弃WORD！教你用Axure快速输出高质量的PRD](http://www.chanpin100.com/article/107230)
 > 【小百摘要】PRD有很多种写法，我知道有一种方式特别轻便。
 ## [让每一次安利不再消耗人设，小优店要帮KOL们打造“信任电商”](http://www.pmtoo.com/article/49435.html)
 > 通过为店主提供优质优价选品，通过提供有保障的供应链、物流、售后服务，让每一次购买都能加固店主和粉丝之间的信任链。而不...
 ## [综艺节目的溃败与重生：明星“已废”，草根“当立”](http://www.pmtoo.com/article/49430.html)
 > 当整个市场的风向开始偏向网综，以明星真人秀为主流的台综是否还会走向原创时代，这是一个值得深思的问题。图片...
 ## [告别音视频会议卡顿，全时都点了哪些“技能树”？](http://www.pmtoo.com/article/49423.html)
 > 作为一家在企业级领域深耕多年的公司，全时都有哪些技术积累？多人远程音视频会议、协同办公已经成为很多企业...
 ## [一文看懂43亿欧元罚单的前因后果：谷歌到底做错了什么？](http://www.pmtoo.com/article/49416.html)
 > 7月18日晚，欧盟委员会对谷歌处以43.4亿欧元(约合50.4亿美元)的反垄断罚款。欧盟下罚单的理由有哪些？谷歌与欧盟的八年恩怨...
 ## [综艺节目的溃败与重生：明星“已废”，草根“当立”](http://www.pmtoo.com/article/49411.html)
 > 当整个市场的风向开始偏向网综，以明星真人秀为主流的台综是否还会走向原创时代，这是一个值得深思的问题。图片...
 ## [没事找事的运营才是好运营](http://www.pmtoo.com/article/49408.html)
 > 不清楚运营到底是做啥的同学，会感觉自己无所事事，或许是因为工作饱和度不够，又或许当有工作安排来时，不知道如何下手，在...
 ## [八年老司机总结了产品工作的5大神坑](http://www.pmtoo.com/article/49405.html)
 > 刚做产品经理的时候，总喜欢跟一些所谓的前辈来请教学习，但不时的听到他们这样的心声：”产品经理其实很简单，就是不断的...
 ## [如何借势世界杯？看这10个运营活动就够了](http://www.pmtoo.com/article/49396.html)
 > 世界杯期间，是各大产品趁热点的好时机，各种运营活动层出不穷。近期看了几十个产品的世界杯运营活动，挑选了一些蛮...
 ## [广告的浪费原则，去浪](http://www.pmtoo.com/article/49391.html)
 > 广告的效果来自于压倒性投入，不想“浪费”就不要做广告。“我知道我的广告费有一半浪费了，但是我不知道是哪一半。”你想把“...
 ## [谷歌被罚 谁动了谁的蛋糕](http://www.pmtoo.com/article/49388.html)
 > 谷歌被欧盟处以超过43亿欧元（约50亿美元）的天价罚款。而且，这既不是第一次被罚，也未必是最后一次被罚。2017年6月，欧...
