...
# IT 技术 
 ...
 > JavaScript是当今流行语言中对函数式编程支持最好的编程语言。我们继续构建函数式编程的基础，在前文中分解
 ## [Skype 8.70.76.48 预览版新增语音降噪功能，切换账号免输密码](http://os.51cto.com/art/202103/649930.htm)
 > 3月14日消息 据外媒 WindowsBlogItalia 消息，微软今日为 Windows 端 Skype 推送了 8.70.76.48 预览版，带
 ## [学C语言的看过来，最完整进制转换、整数和小数内存存储模型](http://developer.51cto.com/art/202103/649929.htm)
 > 进制也就是进位计数制，是人为定义的带进位的计数方法。对于任何一种进制---N进制，就表示每一位置上的数运
 ## [谷歌向符合条件的安卓设备推送 64 位版 Chrome：内存需大于 8GB](http://os.51cto.com/art/202103/649928.htm)
 > 3月14日消息 得益于 6GB 以上大内存的普及，目前的主流的安卓手机大都为 64 位系统底层，距离首个 64 位安
 ## [2021年8个值得关注的DevOps趋势](http://cloud.51cto.com/art/202103/649927.htm)
 ...
 > 
 ## [m1芯片Mac安装哪个版本PS?photoshop哪个版本支持M1？M1芯片处理器安装PS解决方案教程，2021最新方法！](https://blog.csdn.net/x3x4255/article/details/113834882)
