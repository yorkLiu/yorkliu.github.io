...
# IT 技术 
 ...
 ## [推荐一款功能强大的工具包](http://developer.51cto.com/art/202012/634810.htm)
 > 日常开发，往往会使用一些工具类，尽量避免造轮子，一是节约时间成本，二是自己造的轮子不一定比现有轮子好
 ## [支付领域的未来与生物识别息息相关](http://ai.51cto.com/art/202012/634808.htm)
 > 国内整个生物识别市场分为商用市场和公用市场两部分，商用市场瞄准的主要是企业应用，如考勤系统、门禁系统
 ## [修复 NVMe SSD / 音频等多个阻碍 Bug，微软Windows10版本 20H2 大规模推送](http://os.51cto.com/art/202012/634807.htm)
 > 12月15日消息 外媒 Windows Latest 报道，Windows 10 的最新功能更新现在可以兼容更多的设备。
 ## [Java都为我们提供了各种锁，为什么还需要分布式锁？](http://developer.51cto.com/art/202012/634804.htm)
 > 目前的项目单体结构的基本上已经没有了，大多是分布式集群或者是微服务这些。既然是多台服务器。就免不了资
 ## [带宽、延时、吞吐率、PPS 这些都是啥？](http://network.51cto.com/art/202012/634803.htm)
 > Linux 网络协议栈是根据 TCP/IP 模型来实现的，TCP/IP 模型由应用层、传输层、网络层和网络接口层，共四层
 ## [编程语言的支撑体系：构建系统、IDE 和依赖管理](http://developer.51cto.com/art/202012/634802.htm)
 > 年关(annual review)将近，这一段时间，我在梳理 2020 年做的一些事情，并试着制定下一年的计划。
 ## [只要使用这个功能，程序运行速度瞬间提升，高到离谱！](http://developer.51cto.com/art/202012/634800.htm)
 > 在之前如果需要处理集合需要先手动分成几部分，然后为每部分创建线程，最后在合适的时候合并，这是手动处理
 ## [散装 vs 批发谁效率高？变量访问被ARM架构安排的明明白白](http://developer.51cto.com/art/202012/634799.htm)
 > 作为过来人，我发现很多程序猿新手，在编写代码的时候，特别喜欢定义很多独立的全局变量，而不是把这些变
 ## [医学与人工智能交叉融合，打开眼科理疗新窗](http://ai.51cto.com/art/202012/634798.htm)
