...
# IT 技术 
 ...
 > python爬虫--爬取网易云音乐评论
 ## [肝了一夜，用90行代码打造最强PDF转换器，word、PPT、excel、markdown、html一键转换...](https://blog.csdn.net/cainiao_python/article/details/115499784)
...
# PM 
 ...
 > 今天给大家分享一下有关B端产品经理的常见问题“做好B端产品要关注哪些数据指标”，希望本文的分享能帮助到每位走在B端产品之路的产品经理。
 ## [如何理解B端、C端用户的差异？](http://www.chanpin100.com/article/114520)
 > B端的用户和C端的用户在一定程度上来看也是存在很大的差异的，那么要如何理解B端和C端用户的差异呢？下面请看本文的介绍。
 ## [如何做好B端产品用户宣讲？](http://www.chanpin100.com/article/114519)
 > B端产品面向企业用户，B端产品经理不可避免的一项工作就是要给用户做系统的演示和讲解，即用户宣讲，今天我们来讲一讲要如何才能做好B端产品用户宣讲。
 ## [如何系统化学习B端产品知识？](http://www.chanpin100.com/article/114518)
 > 最近小编发现，有很多同学对于B端产品经理这一岗位有许多疑问，不知道如何才能系统化学习B端产品知识，那么今天小编就给大家讲一讲这个问题吧。
 ## [C端转B端产品经理需要做些什么准备？](http://www.chanpin100.com/article/114517)
 > B端产品和C端产品经理完全是两个不同的方向、不同的岗位，那么有些同学想问从C端产品经理转B端产品经理都会遇到什么样的挑战、都要做些什么准备呢？下面就请看小编的分析。
 ## [中台产品经理（18）：大厂数据中台的通俗化解读](http://www.chanpin100.com/article/114516)
 > 如果从比较学术的定义上来讲，数据中台是一种数据组织形式，通过对企业特有的业务模式和组织架构整合，以一套完整的数据产品，为企业构建一套持续不断把数据变成资产并服务于业务的机制。
 ## [一张图了解CRM系统](http://www.chanpin100.com/article/114515)
 > 因工作内容有所涉及，最近看了些CRM的资料，不由觉得CRM体系包含的东西太多、太复杂了，一时间，不知道从何学起。相信大多刚接触CRM的同学，也会有这种感觉。
 ## [企业数智化转型--思路篇](http://www.chanpin100.com/article/114514)
 > 几年前大家都在喊企业数字化转型，最近已经开始大张旗鼓的喊数智化转型。其实数智化一点都不陌生，因为大家一直都在探索数据智能的应用场景，而随着单点业务场景的逐渐落地，对数据智能的信心也越来越强，开始基于沉淀的能力广泛的拓展业务场景边界。
 ## [182亿的天价罚单 对阿里未尝不是一件好事](http://www.chanpin100.com/article/114513)
 > 4月10日，阿里巴巴又被推上风口浪尖。这一天，阿里收到市场监管总局的182.28亿罚单，作为对其之前的“二选一”市场垄断行为的处罚。182.28亿罚款，是阿里巴巴2019年中国境内销售额4557.12亿元的4%。
 ## [2021年中国考研培训行业白皮书](http://www.chanpin100.com/article/114489)
 > 考研培训、互联网教育、成人教育 、数字用户洞察易观分析：在考研需求的高速增长下市场背景之下，近年来专注于其他教育细分领域的企业也纷纷布局考研业务。并且随着市场需求的集中释放，例如考研报考人群不断扩大，报录比的攀升，参培率的不断提高，考研培训服务线上线下进一步融合深化发展等等，考研培训行业发展趋势正在
 ## [教育培训机构拉新的6大方法](http://www.chanpin100.com/article/114475)
 > 获客一直都是业内万年不变的话题，不少的行业都需要通过不断地推广才能有效获得新的客户，形成转化。
 ## [五大管理视角详细解读数据中台](http://www.chanpin100.com/article/114483)
 > 一千个读者，就有一千个哈姆雷特。同样，数据中台对于企业内部不同角色的价值也不同，下面分别从董事长、CEO、 CTO/CIO、IT 架构师、数据分析师这 5 个角色的视角详细解读数据中台。
 ## [逃离手机包围圈 海尔智家用“新居住”定义家的本质](http://www.chanpin100.com/article/114482)
 > 人民视频策划了一场社会性的“挑战1天没有手机的生活”的直播挑战，测试背后是海尔智家三翼鸟“新居住”正在重新定义智慧家庭背后的爱与生活。
 ## [基于用户画像 在线教育企业线索标签体系搭建及培育全流程解析](http://www.chanpin100.com/article/114481)
 > 本文内容均从作者真实实践过程出发，结合作者公司与神策数据合作真实场景，从神策用户画像产品出发，全流程解析线索标签体系搭建及培育。
 ## [如何做好线上教育直播？创客匠人你教三招搞定](http://www.chanpin100.com/article/114480)
