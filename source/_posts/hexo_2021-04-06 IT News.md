...
# IT 技术 
 ...
 > 码哥带大家完成在 CentOS 7 中安装 Redis 6.x 教程。在学习 Redis Cluster 集群之前，我们需要先搭建一套集
 ## [聊聊Axios 如何取消重复请求？](http://developer.51cto.com/art/202104/656024.htm)
 > Axios 是一个基于 Promise 的 HTTP 客户端，同时支持浏览器和 Node.js 环境。它是一个优秀的 HTTP 客户端，
 ## [前所未有地便利！你可知Windows10的CMD还能这么玩](http://os.51cto.com/art/202104/656023.htm)
 > 如果你经常在某个目录下使用CMD之类的命令行，将默认路径改为这个目录，自然方便得多。那么要怎么样自定义C
 ...
 > 白嫖免费域名＋免费服务器
 ## [当红开发语言Go，真的是未来的技术主流吗？](https://blog.csdn.net/devcloud/article/details/115260659)
